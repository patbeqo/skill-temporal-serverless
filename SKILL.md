...
description: 'Deploy and operate Temporal Workers on serverless compute (AWS Lambda) using Worker Cloud Invocations (WCI). Use when the user mentions: "serverless worker", "Temporal serverless", "Worker Cloud Invocation", "WCI", "deploy Temporal worker on Lambda", "Lambda packaging", "Lambda timeout", "WCI inspection", "CloudFormation Temporal".'
version: 0.1.0
---
